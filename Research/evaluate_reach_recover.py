    ...
    if landing:
        ...
        for step in range(20000):
            ...
            if hold_started is not None:
                ...
                stance_blend=0. if touchdown_recovery or support_recovery_started is not None else min(1.,max(0.,(elapsed_hold-(0 if loaded_stance_handover else grip_ramp))/stance_ramp))
                for joint in leg_joints:
                    actuator=walker.mjcf_model.find('actuator',joint.name)
                    if actuator is not None:
